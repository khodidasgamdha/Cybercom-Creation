    ...
    <div>
        <v-layout>
            ...
            <v-flex md9 class="ma-10">
                ...
                <h2 id="title" class="mt-10 mb-5">Additional Information</h2>
                <p v-for="(info, i) in addInfo" :key="i">
                    {{ info }}
                </p>
                <v-btn
