<template>
    <v-container>
        ...
        <!-- if cart have items -->
        <!-- total -->
        <v-card v-if="cartItems.length != 0" class="grey lighten-3 rounded-0 pl-10 mt-5" flat>
            <v-row>
                <v-col cols="4">
                ...
                <v-spacer></v-spacer>
                <v-col cols="3">
                    <p class="headline mb-0">Subtotal ${{ Math.round(cartTotal) }}</p>
                </v-col>
            </v-row>
        </v-card>
        <p v-if="cartItems.length != 0" class="font-weight-bold my-6">Shipment 1 of 1 - Ashley</p>
        ...
        <!-- final bill -->
        <v-card v-if="cartItems.length != 0" class="grey lighten-3 rounded-0 mb-10" flat>
            <v-row class="mx-0">
                <!-- quotas -->
                <v-col md="6">
                    <!-- coupon code -->
                ...
                <v-col md="6">
                    <v-card class="rounded-0 pa-4" flat>
                        ...
                        <v-row class="mb-n7 mt-3 font-weight-bold">
                            ...
                            <v-spacer></v-spacer>
                            <v-col md="auto">${{ Math.round(cartTotal) }}</v-col>
                        </v-row>
