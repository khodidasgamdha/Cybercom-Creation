        ...
        <v-card>
          <v-card-title>
            ...
            <n-link to="/admin/questions/create">
              <v-btn small color="green darken-2" dark>Add</v-btn>
            </n-link>
          </v-card-title>
  ...
  methods: {
    ...
    fetchAnswer(key) {
      this.$axios
        ...
        .then((res) => this.deleteAnswer(key, Object.keys(res.data)[0]))
    },
    deleteAnswer(key, answerId) {
      this.$axios
